...
let package = Package(
    ...
    products: [
        ...
        .executable(name: "GateCPromptPlayer", targets: ["GateCPromptPlayer"]),
        .executable(name: "GateCCallRecorder", targets: ["GateCCallRecorder"])
    ],
    dependencies: [],
    targets: [
        .target(
        ...
        .executableTarget(
            name: "GateCPromptPlayer",
            dependencies: ["CUACProbe"],
            swiftSettings: [
                .swiftLanguageMode(.v5)
            ]
        ),
        .executableTarget(
            name: "GateCCallRecorder",
            dependencies: ["CUACProbe"],
            swiftSettings: [
                .swiftLanguageMode(.v5)
            ]
