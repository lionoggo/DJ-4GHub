...
cp "${ROOT_DIR}/mavo/.build/release/GateCPromptPlayer" "${STAGE_DIR}/bin/dj4ghub-uac-prompt-player"
cp "${ROOT_DIR}/mavo/.build/release/GateCCallRecorder" "${STAGE_DIR}/bin/dj4ghub-uac-call-recorder"
...
chmod 755 "${STAGE_DIR}/dj4ghub" "${STAGE_DIR}/install" \
  "${STAGE_DIR}/bin/dj4ghub-macos" \
  "${STAGE_DIR}/bin/dj4ghub-uac-prompt-player" \
  "${STAGE_DIR}/bin/dj4ghub-uac-call-recorder" \
  "${STAGE_DIR}/lib/libusb-1.0.0.dylib"
codesign --force --sign - "${STAGE_DIR}/lib/libusb-1.0.0.dylib"
codesign --force --sign - "${STAGE_DIR}/bin/dj4ghub-macos"
codesign --force --sign - "${STAGE_DIR}/bin/dj4ghub-uac-prompt-player"
codesign --force --sign - "${STAGE_DIR}/bin/dj4ghub-uac-call-recorder"
